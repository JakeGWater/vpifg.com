...
* You still own your contributions, and can do whatever you like with them. The combined works is governed by our :doc:`LICENSE`. 
...
#. For images or files, the file paths relative to ``sources`` must be listed in :doc:`about/licenses`.
